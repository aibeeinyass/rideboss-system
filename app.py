...
if choice == "COMMAND CENTER":
    ...
    with tab_trans:
        ...
        with tab_mem:
            ...
            # Display persistent success messages after rerun
            if "mem_success" in st.session_state:
                st.success(st.session_state.mem_success)
                del st.session_state.mem_success
            ...
            if mem_action == "ISSUE NEW CARD":
                ...
                m_serial = st.text_input("CARD SERIAL NUMBER (Scan/Type)", placeholder="e.g., RB-26-1001")
                ...
                def confirm_issue():
                    ...
                    if st.button("YES, PAYMENT RECEIVED - ACTIVATE", use_container_width=True, type="primary"):
                        try:
                            ...
                            st.session_state.mem_success = f"✅ Card {m_serial} activated for {m_plate}!"
                            st.rerun()
                        except Exception as e:
